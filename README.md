...
python data.py
```
Please note that data in different formats can be read in different ways. Moreover, different datasets has different sampling interval, it is necessary to change the the corresponding parameters (like "tod") in the code!
